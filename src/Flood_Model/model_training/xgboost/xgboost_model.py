"""
XGBoost Model - Load and Evaluate Trained Model
This script loads a pre-trained XGBoost model and evaluates it on test data.
"""
...
def load_trained_model():
    """Load pre-trained XGBoost model from pickle file"""
    print("\nLoading trained model...")
    model_path = r"C:\Users\ps302\OneDrive\Desktop\Hydrology\src\Flood_Model\model_training\xgboost\best_xgb_model.pkl"

    try:
        # Temporarily remove local paths so pickle can import xgboost.sklearn correctly.
